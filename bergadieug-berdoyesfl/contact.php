						...
						<tbody>
							<form method="get" action="contact_submit.php">
								...
								<tr>
									...
									<input type="radio" name="genre" id="homme" value="homme"><label for="homme">Homme</label>
									<input type="radio" name="genre" id="autre" value="autre"><label for="autre">Autre</label></td>
								</tr>
								<tr>
